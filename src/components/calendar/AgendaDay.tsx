  ...
  return (
    <div className="w-full border rounded-lg overflow-hidden">
      <div className="flex">
        ...
        {/* Grid */}
        <div className="relative flex-1" style={{ height: `${24 * HOUR_HEIGHT}px` }}>
          {Array.from({ length: 24 }).map((_, i) => (
          ...
          {dayReservations.map((res) => {
            ...
            return (
              <button
                ...
                className={`absolute left-2 right-2 border rounded-md p-2 text-left shadow-sm hover:shadow-md transition ${getEventClasses(
                  res.status
                )}`}
                style={{ top, height: 44 }}
